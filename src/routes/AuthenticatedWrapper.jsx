...
import { faUserGroup, faPlus, faRightFromBracket, faGears, faEnvelope, faHatWizard } from '@fortawesome/free-solid-svg-icons';
// import { FontAwesomeIcon as FontAwesome6 } from '@fortawesome/react-fontawesome';
    ...
    return (
        <div className={Styles.Sidebar}>
            ...
            <div className={"buttons is-centered has-addons " + Styles.sidebarButtons}>
                <button className={"button is-" + (state.showFriends?'primary':'dark')} type="button" onClick={() => { setState({ ...state, showFriends: !state.showFriends }) }}>
                    <span className="icon">
                        <FontAwesome6 icon={faUserGroup}/>
                    </span>
                </button>
                <button className={"button is-" + (state.showSettings?'primary':'dark')} type="button" onClick={() => { setState({ ...state, showSettings: !state.showSettings }) }}>
                    <span className="icon">
            ...
            <div className="modal is-active">
                ...
                <div className="modal-card">
                    <header className="modal-card-head">
                        ...
                        <button className="delete is-medium" onClick={() => { setState({ ...state, cropModal: false }) }}></button>
                    </header>
                    <section className="modal-card-body">
